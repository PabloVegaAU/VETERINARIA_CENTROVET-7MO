<x-guest-layout>
    <x-jet-authentication-card>
        <x-slot name="logo">
            <img src="{{ asset('vendor/adminlte/dist/img/CentroVet.png') }}"
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="celular" class="block mt-1 w-full" type="text" :value="old('celular')" name="celular" required />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="domicilio" class="block mt-1 w-full" type="text" :value="old('domicilio')" name="domicilio" required />
            </div>
